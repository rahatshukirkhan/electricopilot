...
>   методы C/B1, Cu/Al, PVC. Транскрипция подлежит проверке инженером (`_citation.verified_by`).
>
...
- **Реальные публичные данные** (`public_standard`) вносятся ТОЛЬКО кодом из официального
  ...
  (печать таблиц + авто-проверки монотонности/выбросов) — протокол в `docs/04 §4.6`.
